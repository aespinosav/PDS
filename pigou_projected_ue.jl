...
#Flow
F = x -> [1, x[2]] # 1/2 B x (equivalent to beckmann functional)
...
plot(orb.trajectory[end,:]..., "ok", markersize=7)
label_pos = orb.trajectory[end,:] + 0.015*[1,1]
text(label_pos[1],label_pos[2], "xᵁᴱ", fontsize=20)
